   ...
   //Checks authorisation and if the user of the website is logged in. User will be redirected if not
    ...
    public function index()
    {
      ...
      ->get();
         ...
         return view('pages.dailyMusic')->with('SetGenre' , $SetGenre , 'instrumentalnessMin' , $instrumentalnessMin , 'instrumentalnessMax' , $instrumentalnessMax , 'randomUser', $randomUser);
    }
